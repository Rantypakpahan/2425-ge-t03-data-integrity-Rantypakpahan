...
public class Driver2 {
    public static void main(String[] args) {
        ...
        Set<String> displayedErrors = new LinkedHashSet<>(); // Menjaga urutan error tetap konsisten
        ...
        students.sort(Comparator.comparing(Student::getNama)); // Urutkan berdasarkan nama dari A-Z
